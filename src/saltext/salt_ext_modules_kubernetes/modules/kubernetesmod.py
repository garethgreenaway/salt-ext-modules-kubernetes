...
def replica_sets(namespace="default", **kwargs):
    """
...
def show_replica_set(name, namespace="default", **kwargs):
    ...
    CLI Examples::
        ...
        salt '*' kubernetes.show_replica_set game-config default
        salt '*' kubernetes.show_replica_set name=game-config namespace=default
    """
    cfg = _setup_conn(**kwargs)
    try:
        api_instance = kubernetes.client.ExtensionsV1beta1Api()
        ...
        if isinstance(exc, ApiException) and exc.status == 404:
            ...
            log.exception(
                "Exception when calling " "CoreV1Api->read_namespaced_replica_set"
            )
            raise CommandExecutionError(exc)
    finally:
        _cleanup(**cfg)
...
def delete_deployment(
    ...
    **kwargs
    ...
    :param namespace:
        The namespace where the deployment should be deleted from.
        By default the "default" namespace is used.

    :param grace_period_seconds:
        The duration in seconds before the deployment should be deleted.
        By default a grace period of 0 is used so the deployment is deleted
        immediately.
    ...
    :param propagation_policy:
        ...
        Valid attributes are:
            Orphan - to orphan the dependants. (Default)
            Background - allow garbage collector to delete dependants in the background.
            Foreground - cascading policy that deletes dependants in the foreground.
    ...
    body = kubernetes.client.V1DeleteOptions(
        grace_period_seconds=grace_period_seconds, propagation_policy=propagation_policy
    )
...
def delete_service(
    ...
    **kwargs
    ...
    :param namespace:
        The namespace where the service should be deleted from.
        By default the "default" namespace is used.

    :param grace_period_seconds:
        The duration in seconds before the service should be deleted.
        By default a grace period of 0 is used so the server is deleted
        immediately.
...
def delete_namespace(
    name, grace_period_seconds=0, propagation_policy="Orphan", **kwargs
):
    """
    ...
    :param grace_period_seconds:
        The duration in seconds before the namespace should be deleted.
        By default a grace period of 0 is used so the server is deleted
        immediately.
...
def delete_secret(
    ...
    **kwargs
    ...
    :param namespace:
        The namespace where the secret should be deleted from.
        By default the "default" namespace is used.

    :param grace_period_seconds:
        The duration in seconds before the secret should be deleted.
        By default a grace period of 0 is used so the server is deleted
        immediately.
...
def delete_configmap(
    ...
    **kwargs
    ...
    :param namespace:
        The namespace where the configmap should be deleted from.
        By default the "default" namespace is used.

    :param grace_period_seconds:
        The duration in seconds before the configmap should be deleted.
        By default a grace period of 0 is used so the server is deleted
        immediately.
    ...
    :param propagation_policy:
        ...
        Valid attributes are:
            Orphan - to orphan the dependants.
            Background - allow garbage collector to delete dependants in the background.
            Foreground - cascading policy that deletes dependants in the foreground.
...
def delete_replica_set(
    ...
    **kwargs
    ...
    """
    Deletes the kubernetes replica set defined by name and namespace

    :param name:
        The name of the replica set to delete

    :param namespace:
        The namespace where the replica set should be deleted from.
        By default the "default" namespace is used.

    :param grace_period_seconds:
        The duration in seconds before the replica set should be deleted.
        By default a grace period of 0 is used so the server is deleted
        immediately.
    ...
    CLI Examples::
        ...
        salt '*' kubernetes.delete_replica_set my-replica-set default
        salt '*' kubernetes.delete_replica_set name=my-replica-set namespace=default
    """
    cfg = _setup_conn(**kwargs)
    body = kubernetes.client.V1DeleteOptions(
        grace_period_seconds=grace_period_seconds, propagation_policy=propagation_policy
    ...
    try:
        ...
        if isinstance(exc, ApiException) and exc.status == 404:
            ...
            log.exception(
                "Exception when calling " "CoreV1Api->delete_namespaced_replica_set"
            )
            raise CommandExecutionError(exc)
    finally:
        _cleanup(**cfg)
